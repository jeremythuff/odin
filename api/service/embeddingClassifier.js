...
const PROTOTYPES = {
  ...
  [ROUTES.REFERENCE]: [
    ...
    'that children’s book where the caterpillar eats everything',
    'a film about a lawyer defending an innocent man in Alabama',
    'a book about a wizard boy who goes to a special school',
    'the novel where the man wakes up as a bug',
    'the story about a whale and a sea captain',
    'a documentary about coral reefs narrated by a British naturalist',
    'a blue hardcover cookbook that came out in the 1970s',
    'the romance novel set in Regency England with two sisters',
    'the adventure story with a treasure map and pirates',
  ],
  ...
  [ROUTES.EXPLORATORY]: [
    ...
    'best introductions to quantum computing',
    'academic works about gender theory and literature',
    'guides to building sustainable architecture',
    'studies on climate change impact in agriculture',
    'books about Renaissance art techniques',
    'papers on machine learning fairness and bias',
    'articles about the history of flight',
    'books discussing postcolonial philosophy',
    'publications on ancient Greek mythology',
  ],
  ...
  [ROUTES.COMPARATIVE]: [
    ...
    'novels similar to The Hobbit',
    'like The Handmaid’s Tale but set in the future',
    'series like Harry Potter for adults',
    'books with the tone of The Road by Cormac McCarthy',
    'authors similar to Brandon Sanderson',
    'shows or films like Stranger Things',
    'something with the atmosphere of Blade Runner',
    'similar to The Great Gatsby but contemporary',
    'fantasy novels reminiscent of Mistborn',
  ],
};
